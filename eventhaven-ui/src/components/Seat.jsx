...
export function Seat({ seat, isSelected, readOnly = false, onSelect }) {
  ...
  const seatClass = cn(
    ...
    readOnlyAvailable && "cursor-not-allowed border-2 border-violet-400 bg-white text-violet-700 hover:translate-y-0 hover:shadow-none",
    seat.status === "AVAILABLE" && !isSelected && !readOnlyAvailable && "border-2 border-violet-400 bg-white text-violet-700 hover:-translate-y-0.5 hover:shadow-md",
